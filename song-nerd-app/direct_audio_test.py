...
def extract_audio_features_direct(audio_path):
    ...
    try:
        ...
        # Extract all the features your ML models need
        features = {}
        ...
        # 4. Danceability (beat consistency and strength)
        ...
        # 10. Liveness (reverb and room characteristics)
        ...
        # 12. Time signature (simplified)
        features['time_signature'] = 4  # Default to 4/4
        
        # 13. Audio appeal (quality score)
        ...
        # 14. Add required features for ML models
...
def test_with_ml_models(features):
    ...
    try:
        ...
        if not analyzer.models_loaded:
            print("⚠️  ML models not loaded - need to run training first")
            return False
        ...
        if 'error' not in analysis:
            ...
            print(f"⚠️  Got basic analysis (models need training)")
            return True
            
    except ImportError:
        print(f"⚠️  ML models not available")
        return True
    except Exception as e:
...
def main():
    ...
    if features:
        ...
        if ml_success:
            ...
            print(f"\n⚠️  Audio processing works, but ML models need setup")
